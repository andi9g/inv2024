...
@section("warnaexpired", "bg-primary")

@section("judul", "Data Barang Expired")
      ...
      <div class="modal-dialog" role="document">
         <div class="modal-content">
            <div class="modal-header">
               <h5 class="modal-title" id="my-modal-title">Cetak Laporan Expired</h5>
               <button class="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
               </button>
            </div>
            <form action="{{ route('cetak.expired', []) }}" target="_blank" method="GET">
               @csrf
